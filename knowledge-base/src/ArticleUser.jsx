    ...
    <div className='hunid'>
        ...
        <Container key={articles.articlesId} fluid="md ml-5 mr-5 articleContainer ">
            ...
            <Col  className="d-flex centero">
                <h2 className='black mb-3'><Link to = "/blogs" className="text-decoration-none black boldi">Blogs   </Link> <span><FontAwesomeIcon icon={faAnglesRight} /></span> <span>{articles.articlesTitle}</span></h2>
